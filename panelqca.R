...
DIVfunction <- function(x, units, time, cond, out, n_cut, incl_cut, BE_cons, WI_cons) {
...
WOPfunctionCP <- function(x, units, time, cond, out, n_cut, incl_cut, solution, BE_cons, WI_cons) {
...
WOPfunctionInter <- function(x, units, time, cond, out, n_cut, incl_cut, intermediate, BE_cons, WI_cons) {
...
Thiem2011 <- read.table(file = "ThiemPanel051.csv", fileEncoding = "WINDOWS-1252", stringsAsFactors = FALSE, header = TRUE, sep = ";")
